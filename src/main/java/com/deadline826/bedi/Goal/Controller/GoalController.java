...
public class GoalController {
    ...
    public String postGoal(@RequestBody GoalPostDto goalPostDto, HttpServletResponse response,
                          RedirectAttributes redirectAttributes) throws CustomIOException {
    ...
    public ResponseEntity editGoal(@RequestBody GoalPostDto goalPostDto, @PathVariable Long goalId, HttpServletResponse response) throws CustomIOException {
